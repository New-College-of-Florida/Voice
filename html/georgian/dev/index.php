  ...
  <body class="text-center body-short">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        <h1 class="cover-heading">Teach Yourself Georgian Dataset: A Corpus Of Traditional A Cappella Vocal Polyphony</h1>
        <p class="lead">David Gillman*, Uday Goyat†, and Atalay Kutlay‡*</p>
        <p class="lead">
          <a href="paper.php" class="btn btn-lg btn-secondary">Learn more</a>
          <a href="tool.php" class="btn btn-lg btn-secondary">Song Visualizations</a>
        </p>
      </main>
