    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover" style="margin-top:50px;">
        <h1 class="cover-heading">Song Visualizations</h1>
           ...
           <a href="javascript: change_y_axis_frequency()" class="btn btn-lg btn-secondary">Switch to Frequency</a> - <a href="javascript: change_y_axis_cents()" class="btn btn-lg btn-secondary">Switch to Cents</a>
